...
class Student(Human):
    ...
    def __str__(self):
        return f"Студент: {super().__str__()}, Залікова книжка: {self.record_book}"
...
assert isinstance(gr.find_student('Jobs'), Student) is True, 'Метод поиска повинен повертати екземпляр'
